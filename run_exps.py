...
def main():
    ...
    parser.add_argument('--num_correction', default=5, help='number of self coorection iterations to perform')
    ...
    for data_path in data_paths:
        ...
        for i in range(args.num_correction):
            run(f'python main.py --data_root {data_path} --device {args.device} --restart --output_dir difference --use_opt --rtol_hi 0.100 --rtol_lo 0.100 --iter 2000')  # use difference in rendered values
