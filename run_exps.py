...
def main():
    ...
    parser.add_argument('--num_correction', default=500, help='number of self coorection iterations to perform')
    ...
    for data_path in data_paths:
        ...
        run(f'python main.py --data_root {data_path} --device {args.device} --output_dir difference --use_opt --repeat {args.num_correction} --iter 200 --rtol_hi_opt 0.050 --rtol_lo_opt 0.050')  # use difference in rendered values (100 is more than enough)
